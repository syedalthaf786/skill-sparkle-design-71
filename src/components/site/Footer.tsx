    ...
    <footer className="border-t border-border bg-surface">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              <Mail size={14} className="mt-1 text-primary" /> info@novastack.io
            </li>
            <li className="flex items-start gap-2">
              <Phone size={14} className="mt-1 text-primary" /> +91 98765 43210
            </li>
            <li className="flex items-start gap-2">
      ...
      <div className="border-t border-border">
        <div className="container-x flex flex-col items-center justify-between gap-2 py-5 text-xs text-muted-foreground md:flex-row">
          ...
          <p>
            Design by <img src={logo} alt="Logo" width="80" />
          </p>
        </div>
      </div>
    </footer>
