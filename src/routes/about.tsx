...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — NovaStack Technologies" },
      { name: "description", content: "We are a technology-focused company providing reliable Data Services and IT Solutions worldwide." },
    ...
    <div>
      <section className="relative overflow-hidden">
        ...
        <div className="container-x py-20 lg:py-28">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold md:text-6xl">
            Building <span className="brand-text">intelligent systems</span> for ambitious businesses.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            We are a technology-focused company providing reliable Data Services and IT Solutions for businesses worldwide. Our expertise spans AI data annotation, image labeling, web design, software development, automation, and digital transformation.
          </p>
        </div>
      </section>
      ...
      <section className="container-x grid gap-12 py-20 lg:grid-cols-2">
        ...
        <div className="space-y-4 text-muted-foreground">
          ...
          <p>From annotating training datasets for cutting-edge AI models to architecting cloud-native software platforms, our team brings depth across the modern technology stack — and a commitment to outcomes that move your business forward.</p>
          <Link to="/contact" className="btn-primary mt-4">Work With Us <ArrowRight size={16} /></Link>
        </div>
      </section>
    </div>
  );
