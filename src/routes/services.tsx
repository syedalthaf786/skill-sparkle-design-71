...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Services — Data, Web & IT Solutions | NovaStack" },
      { name: "description", content: "AI data annotation, web design & development, and custom IT software solutions for startups and enterprises." },
      { property: "og:title", content: "NovaStack Services" },
      { property: "og:description", content: "End-to-end technology services tailored for modern businesses." },
    ],
  }),
...
const services = [
  {
    ...
    items: ["Image Annotation", "Bounding Box Labeling", "Polygon Annotation", "Semantic Segmentation", "Video Annotation", "OCR Annotation", "Text Annotation", "NLP Data Tagging", "Audio Transcription", "Validation & QA"],
  },
  {
    icon: Code2,
    ...
    items: ["Business Websites", "Portfolio Websites", "E-Commerce Development", "Landing Pages", "UI/UX Design", "Responsive Design", "SEO Optimization", "Website Maintenance"],
  },
  {
    icon: Cpu,
    ...
    items: ["Custom Software Development", "AI & ML Solutions", "Automation Systems", "Cloud Solutions", "API Development", "Database Management", "Technical Support", "IT Consulting"],
  },
];
    ...
    <div>
      <section className="relative overflow-hidden">
        ...
        <div className="container-x py-20 lg:py-28">
          ...
          <h1 className="mt-4 max-w-3xl text-4xl font-bold md:text-6xl">
            End-to-end <span className="brand-text">technology services</span> for every stage of growth.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
            From training-grade datasets to production-ready software, our team ships the work that powers modern businesses.
          </p>
        </div>
      </section>
      ...
      <section className="container-x space-y-10 pb-24">
        ...
        <div className="rounded-3xl border border-border p-10 text-center md:p-14" style={{ background: "var(--gradient-brand)" }}>
          <h2 className="text-3xl font-bold text-primary-foreground md:text-4xl">Ready to start your project?</h2>
          <Link to="/contact" className="mt-6 inline-flex items-center gap-2 rounded-full bg-background px-6 py-3 text-sm font-semibold text-foreground transition hover:scale-105">
